...
const items = [
  {
    icon: <PiHouseFill className="text-2xl text-purple-800" />,
    ...
    <>
      <div className="flex flex-col pt-32  items-center justify-center">
        <div
         ...
         items-center flex"
        >
          Why we should use Ikarus identifier
        </div>
        <div className="text-sky-500 flex items-center  hover:cursor-pointer pt-6">
      ...
      >
        {items.map((item, index) => (
          <div
            ...
            className={`${
              index === 0
                ? " xl:col-span-2 xl:row-span-3 md:row-span-2 md:col-span-2  flex-col md:flex-col xl:flex-col"
                : ""
            } bg-[#f6f5f4] p-6 rounded-xl  flex ${
              index === 0 ? "justify-center items-center" : ""
            }`}
          >
