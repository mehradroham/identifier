  ...
  const handleImagesChange = async (files: File[]) => {
    ...
    try {
      ...
      const options = {
        ...
        headers: {
          Authorization:
            "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..P8adOyyTHc3U1c3I17cA8geeRXIpQ-T4w3fN6Jpy7eU",
        },
        body: form,
      };

      const response = await fetch(
        "https://red-magic-felidae-346.mypinata.cloud",
        options
      );
    ...
    <div className="flex flex-col md:flex-row items-center md:items-start justify-between space-y-4 md:space-y-0 md:space-x-10 pt-20 pb-20 px-4 md:px-16">
      <div>
        <div className="md:text-4xl text-xl font-medium w-3/3 pb-3">
          ...
          <span className="text-purple-700">Ikarus</span>
        </div>
        <Toaster />
